\usepackage{fontspec}
\usepackage[GreekAndCoptic, BasicLatin, PhoneticExtensions, IPAExtensions, CombiningDiacriticalMarks, SpacingModifierLetters]{ucharclasses}
...
%\setmainfont{Doulos SIL} % Set main font for latin characters
...
\setTransitionTo{GreekAndCoptic}{\ipa}
\setTransitionTo{PhoneticExtensions}{\ipa}
\setTransitionTo{IPAExtensions}{\ipa}
\setTransitionTo{CombiningDiacriticalMarks}{\ipa}
\setTransitionTo{SpacingModifierLetters}{\ipa}
